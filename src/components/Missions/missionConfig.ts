...
const city3Missions: MissionConfig[] = [
  ...
  {
    id: "night3-priest",
    pickupPosition: [-11.671, 0.1, -410.476],
    passengerPosition: [-11.671, 0.3, -410.476],
    dropoffPosition: [5.209, 0, -532.931],
  ...
  },
  {
    ...
    dropoffPosition: [125.558, 0, -484.766],
  ...
  {
    id: "night3-voice",
    pickupPosition: [45.879, 0.1, -508.37],
    passengerPosition: [45.879, 0.1, -508.37],
    dropoffPosition: [-22.638, 0.1, -409.8],
