...
export function setupEnvironment(scene: THREE.Scene): EnvironmentAssets {
  const car = createPlayerCar(scene);
  const stripes = addRoadNetwork(scene);
  addAtmospherics(scene);
  addLighting(scene);
  addResidentialPlots(scene);
...
function createPlayerCar(scene: THREE.Scene): THREE.Group {
...
function addRoadNetwork(scene: THREE.Scene): THREE.Mesh[] {
...
function addAtmospherics(scene: THREE.Scene): void {
...
function addResidentialPlots(scene: THREE.Scene): void {
  const housePlots = [
