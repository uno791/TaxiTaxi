...
const city1Missions: MissionConfig[] = [
  ...
  },
  {
    ...
    pickupPosition: [-6, 0, -32],
    passengerPosition: [-6, 0, -32],
  ...
  },
  {
    ...
    pickupPosition: [-42, 0, -8],
    passengerPosition: [-42, 0, -8],
...
const city2Missions: MissionConfig[] = [
    ...
    dialogue: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: "You shouldn't be out this late." },
        ],
      },
      {
        speaker: "passenger",
  ...
  },
  {
    ...
    pickupPosition: [104, 0.1, -136],
    passengerPosition: [104, 0.1, -136],
    dropoffPosition: [136, 0.1, -150],
  ...
  {
    id: "night2-nun",
    pickupPosition: [112, 0.1, -180],
    passengerPosition: [112, 0.1, -180],
    dropoffPosition: [84, 0.1, -156],
  ...
  },
  {
    ...
    pickupPosition: [98, 0.1, -164],
    passengerPosition: [98, 0.1, -164],
    dropoffPosition: [120, 0.1, -192],
  ...
  {
    id: "night2-officer",
    pickupPosition: [124, 0.1, -144],
    passengerPosition: [124, 0.1, -144],
    dropoffPosition: [88, 0.1, -200],
...
const city3Missions: MissionConfig[] = [
  ...
  },
  {
    ...
    pickupPosition: [32, 0.1, -460],
    passengerPosition: [32, 0.1, -460],
    dropoffPosition: [10, 0.1, -498],
  ...
  {
    id: "night3-child",
    pickupPosition: [58, 0.1, -440],
    passengerPosition: [58, 0.1, -440],
    dropoffPosition: [30, 0.1, -520],
  ...
  {
    id: "night3-widow",
    pickupPosition: [20, 0.1, -490],
    passengerPosition: [20, 0.1, -490],
    dropoffPosition: [48, 0.1, -540],
  ...
  {
    id: "night3-reaper",
    pickupPosition: [8, 0.1, -452],
    passengerPosition: [8, 0.1, -452],
