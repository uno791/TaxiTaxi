...
export default function Allbuildings(props: JSX.IntrinsicElements["group"]) {
  return (
    <group {...props}>
      ...
      <BlockBuildings position={[-2.5,0,-53.3]} rotation={[0, Math.PI/2, 0]}/>
      <BlockBuildings position={[25.5,0,-45.25]} rotation={[0, Math.PI/2, 0]} scale={[1,2,1.45]}/>
      <BlockBuildings position={[25.5,0,-28.25]} rotation={[0, Math.PI/2, 0]} scale={[0.87,2,1.45]}/>
